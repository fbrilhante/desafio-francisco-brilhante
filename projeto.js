const { Pagamentos } = require("./enums/pagamentos.js");
const { cardapio } = require("./cardapio/cardapio.js");
        ...
        if (!itens) {
            ...
            for (const item of itens) {
                ...
                if (!cardapio.hasOwnProperty(itemName)) {
                    ...
                    if (
                        (itemBuscado === "chantily" && !HaCafe) ||
                        (itemBuscado === "queijo" && !HaSanduiche)
                    ) {
                    ...
                    this.valorDoPedido = Number(
                        (this.valorDoPedido + precoACobrar) * this.valorDeAbate
                    ).toFixed(2);
                }
            }
        }
